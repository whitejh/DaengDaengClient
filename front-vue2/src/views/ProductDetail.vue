...
<template>
		...
		<div class="container padding-bottom-3x mb-1">
			<div class="row">
				<!-- 상품 정보 관련 -->
				<div class="col-md-6" :image1="firstImage" :image2="secondImage" :image3="thirdImage">
					<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
					<div class="carousel-indicators">
						<button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
						<button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2" v-if="secondImage!=='1'"></button>
						<button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3" v-if="thirdImage!=='1'"></button>
					</div>
					...
					<div class="carousel-inner">
						...
						<div class="carousel-item" v-bind:image1="secondImage" v-if="secondImage!=='1'">
							<img :src="secondImage" class="d-block w-100" alt="item">
						</div>
						<div class="carousel-item" v-bind:image1="thirdImage" v-if="thirdImage!=='1'">
				...
				<div class="col-md-6">
					...
					<span class="text-muted align-middle" style="float: right"
						>&nbsp;&nbsp;카테고리 | {{this.goodsData.bigCategory}} | {{this.goodsData.midCategory}} &nbsp;&nbsp;&nbsp;&nbsp;{{this.goodsData.createdAt}}
						전<br />
					</span>
...
export default {
	...
	methods: { 
		...
		handleSubmit() {
			...
			let today=new Date();
			let jsonBlame={"id":id,"blameStatus":"no","content":content,"createdAt":today};
			try{
