<template>
  <div id="mypage">
    ...
    <div class="offcanvas-wrapper">
      ...
      <div class="modal fade" id="afterModal" tabindex="-1" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" id="afterModal">
          ...
          >
            ...
            <div class="card-group">
              ...
              <div class="card">
                ...
                />
                <div class="card-body">
                  <h5 class="card-title">강아지 타워</h5>
                  <p class="card-text">12,000원</p>
                  <p class="card-text">성수동</p>
            ...
            <div class="container padding-bottom-3x mb-1">
              ...
              <section>
                ...
                <div class="location-result-box">
                  <div class="">
                    현재 위치가 &nbsp;
                    <p style="color: rgb(13, 169, 239)">'용산구'</p>
                    &nbsp;에 있어요
                  </div>
                </div>
